...
CREATE VIEW Student_Details AS SELECT Branch ,Name , SPI  FROM STUDENT_INFO;
...
--6. Insert a new record to Student_Pattern view. (107, Meet, ME)
INSERT INTO Student_Pattern VALUES (107, 'Meet', 'ME');
...
CREATE VIEW displays AS SELECT *FROM STUDENT_INFO WHERE SPI>8.5;
SELECT *FROM displays;

--2. Create a view that displays 0 backlog students.
CREATE VIEW VM_BKLOG AS SELECT *FROM STUDENT_INFO WHERE Bklog>0;
SELECT *FROM VM_BKLOG;
